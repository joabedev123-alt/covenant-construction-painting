  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-2">
        <ContentAnchor
          cmsId="components-MobileCallBar-link-1"
        ...
        >
          ...
          <span className="truncate">
            <ContentText id="components-MobileCallBar-text-1">
              {"Call Now"}
            </ContentText>
          </span>
        </ContentAnchor>
        ...
        <Link
          cmsId="components-MobileCallBar-link-2"
          href="/contact"
        ...
        >
          ...
          <span className="truncate">
            <ContentText id="components-MobileCallBar-text-2">
              {"Get Estimate"}
            </ContentText>
          </span>
        </Link>
